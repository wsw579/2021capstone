...
import com.example.capstone.NonNull;
import com.example.capstone.R;
import com.example.capstone.view.AutoFitTextureView;
...
public class Camera2BasicFragment extends Fragment
    ...
    /**  이 코드는 필요없어서 지웠는데 혹시몰라 나뒀습니다 - 승원
    ...
    //이걸 복붙해서 바꿔놓고는 원래꺼를 왜 안지우고 ImageSaver -> ImageUpLoader로 바꿔서 하는지 의문,,,
    // 일단 저는 원래 코드는 주석처리 했습니다. - 수진
    // 처음에 주석처리를 못보고 진행을 했는데
    // part7에서 이 부분을 주석처리해서 제대로 작동이 안했네요. 이제부터는 오류가 나지않는이상 코드 그냥 놔두는게
    //나을거같아요 -승원
    //Saves a JPEG {@link Image} into the specified {@link File}.
